    ...
    t.prototype.initTooltipPlugin = function() {
        ...
        e('[data-plugin="custommodal"]').on("click", function(t) {
            t.preventDefault(), new Custombox.modal({
                content: {
                    target: e(this).attr("href"),
                    effect: e(this).attr("data-animation")
                },
                overlay: {
                    color: e(this).attr("data-overlayColor")
                }
            }).open()
        })
        ...
        e('[data-plugin="peity-pie"]').each(function(t, i) {
            var a = e(this).attr("data-colors") ? e(this).attr("data-colors").split(",") : [],
                o = e(this).attr("data-width") ? e(this).attr("data-width") : 20,
                n = e(this).attr("data-height") ? e(this).attr("data-height") : 20;
            e(this).peity("pie", {
                fill: a,
                width: o,
                height: n
...
function(a) {
    ...
    t.prototype._resetSidebarScroll = function() {
        ...
        a(".button-menu-mobile").on("click", function(t) {
        ...
        }), a("#side-menu").metisMenu(), i._resetSidebarScroll(), a(".right-bar-toggle").on("click", function(t) {
            ...
            this.href == t && (a(this).addClass("active"), a(this).parent().addClass("mm-active"), a(this).parent().parent().addClass("mm-show"), a(this).parent().parent().prev().addClass("active"), a(this).parent().parent().parent().addClass("mm-active"), a(this).parent().parent().parent().parent().addClass("mm-show"), a(this).parent().parent().parent().parent().parent().addClass("mm-active"))
